...
def convert_rawdata_to_pkldata() -> None:
    ...
    if not global_config["all"]["flag_more_feat_types"]:
        ...
        data_loader_dl.data_loader_np(ds_keys_dict=ds_keys_dict, flag_normalize=False, flag_more_feat_types=False)
        ...
        data_loader_dl.data_loader_np(ds_keys_dict=ds_keys_dict, flag_normalize=False, flag_more_feat_types=True)
